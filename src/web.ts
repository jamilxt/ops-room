 ...
 * First connected client AUTO-STARTS a run (open the tab, watch it go).
 *
 ...
 * ZERO escape sequences — pure string ops. Do not "fix" this. See commit
 * history (regex escapes froze the page at parse time once already).
 */
