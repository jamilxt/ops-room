...
| 9 | 1:48–2:00 | VS Code close-up: `incident-timeline-v4.md`, scroll; end card | "The scribe wrote all of it down, live — timestamps interleaved, never sequential. OpsRoom: twelve participants, one bus, zero orchestrators — and the enforcement layer Mozaik's own launch essay calls the missing piece." |
