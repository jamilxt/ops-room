...
- `T+5.0s [sleuth] error signature: TIMEOUT_ERROR in orders-api/src/main/ts/pool.ts — first seen right after deploy window opened`
...
- `T+14.0s [sleuth] error signature: CHECKOUT_LOCK_ERROR in orders-api/src/main/ts/handler.ts — first seen right after deploy window opened`
